...
module.exports = {
    ...
    cacheDirectory: path.resolve('node_modules/.cache/jest/server'),
    ...
    testMatch: ['**/__tests__/**/*.(spec|test).[jt]s', '**/?(*.)+(spec|test).[tj]s'],
    ...
    transform: {
        '^.+\\.(js|ts)$': '<rootDir>/config/jest/nodeTransformer.js',
    },
